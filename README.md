...
It demonstrates how to utilize [Backdoors in UITest](https://docs.microsoft.com/appcenter/test-cloud/uitest/working-with-backdoors?WT.mc_id=mobile-0000-bramin) to bypass a login screen, improving the speed of the tests. 
