...
namespace UITestSampleApp
{
    class WeakEventManager
    {
        ...
        {
            var isValidValue = _eventHandlers.TryGetValue(eventName, out List<Subscription> targets);
            if (!isValidValue)
            {
        ...
        {
            var isValidValue = _eventHandlers.TryGetValue(eventName, out List<Subscription> subscriptions);
            if (!isValidValue)
                return;
